 ...
 * Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/azrcrv-remove-revisions/releases/latest/).
...
### [Version 1.2.5](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.5)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.2.4](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.4)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.
 
### [Version 1.2.3](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.3)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.2.2](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.2)
 * Fix Update Manager View Details link (contributed by xxsimoxx).
 * Fix bug with display of plugin action link.

### [Version 1.2.1](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.1)
 * Fix missing constants.
 
### [Version 1.2.0](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.2.0)
 * Update plugin list.
...
### [Version 1.0.4](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.0.4)
 * Update azurecurve menu.
 * Update readme files.

### [Version 1.0.3](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.0.3)
 * Fix bug with plugin icon and banner not displaying.

### [Version 1.0.2](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.0.2)
 * Fix version number issue.

### [Version 1.0.1](https://github.com/azurecurve/azrcrv-remove-revisions/releases/v1.0.1)
