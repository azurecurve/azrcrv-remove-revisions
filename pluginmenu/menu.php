 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_rr' ) ) {
	function azrcrv_create_plugin_menu_rr() {
		azrcrv_populate_plugin_menu_rr();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_rr' ) ) {
	function azrcrv_populate_plugin_menu_rr() {
