...
<form method="post" action="admin-post.php">
		...
		<div id="tabs" class="azrcrv-ui-tabs">
			<ul class="azrcrv-ui-tabs-nav azrcrv-ui-widget-header" role="tablist">
				...
				<li class="azrcrv-ui-state-default" aria-controls="tab-panel-cron" aria-labelledby="tab-cron" aria-selected="false" aria-expanded="false" role="tab">
					<?php // phpcs:ignore. ?>
					<a id="tab-cron" class="azrcrv-ui-tabs-anchor" href="#tab-panel-cron"><?php echo $tab_cron_label; ?></a>
				</li>
			...
			<div id="tab-panel-cron" class="azrcrv-ui-tabs-scroll azrcrv-ui-tabs-hidden" role="tabpanel" aria-hidden="true">
				<fieldset>
					<legend class='screen-reader-text'>
						<?php
						// phpcs:ignore.
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-rr' ); ?>" class="button-primary"/>
	<input type="submit" name="btn_save_remove" value="<?php esc_html_e( 'Save Settings & Remove Revisions', 'azrcrv-rr' ); ?>" class="button-secondary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-rr' );
		?>
	</span>
</div>
